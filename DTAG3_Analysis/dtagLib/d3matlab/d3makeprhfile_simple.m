function TagData = d3makeprhfile_simple(tag, df, TagData)
%
...
TagData.pitchDeg = rad2deg(pitch);
TagData.rollDeg = rad2deg(roll);
TagData.headDeg = rad2deg(head);
TagData.accelTag = A;
TagData.magTag = M;
TagData.accelAnim = Aw;
TagData.magAnim = Mw;
TagData.sampleFreqtag = fs;