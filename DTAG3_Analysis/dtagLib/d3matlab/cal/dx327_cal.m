...
PRESS=struct;
PRESS.POLY=[237.46, 2020.29, -91.13];
PRESS.METHOD='rough';
...
ACC.POLY=[10.1330, -5.1154; 10.1335, -5.0450; 10.1378, -5.0439];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[622.4375, -199.8126; 609.6913, -193.3543; 624.6138, -213.9884];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
