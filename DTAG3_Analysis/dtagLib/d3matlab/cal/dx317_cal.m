%Dtag3X #317 Cal file
%Initial cal June 6, 2018
%Update Commented fields as needed
...
PRESS=struct;
PRESS.POLY=[32.97 2340.55 -76.02];
PRESS.METHOD='rough';
PRESS.LASTCAL=[2018 6 6];
PRESS.TREF = 20 ;
...
ACC.POLY=[10.0311 -4.91121; 10.0904 -5.04112; 10.0134 -4.96594];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
ACC.METHOD='flips';
ACC.LASTCAL=[2018 6 6];

MAG=struct;
MAG.TYPE='magnetoresistive bridge';
MAG.POLY=[661.5615 -236.6201; 674.7269 -208.0492; 691.9393 -166.4296];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
