...
PRESS=struct;
PRESS.POLY=[139.25 2319.86 -103.88];
PRESS.METHOD='rough';
...
ACC.METHOD='flips';
ACC.LASTCAL=[2023 6 8];

MAG=struct;
MAG.TYPE='magnetoresistive bridge';
MAG.POLY=[734.31       -325.14
          756.16       -248.85
          719.60       -242.74];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
