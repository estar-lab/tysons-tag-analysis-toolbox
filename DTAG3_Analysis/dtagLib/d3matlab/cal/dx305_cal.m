...
PRESS.POLY=[-78.945345 2826.357 -81.708464];
PRESS.METHOD='rough';
PRESS.LASTCAL=[2017 5 12];
PRESS.TREF = 20 ;
...
ACC.POLY=[10.0402 -5.0484; 10.1097 -5.0207; 10.1569 -5.0745];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
ACC.METHOD='flips';
ACC.LASTCAL=[2017 5 12];

MAG=struct;
MAG.TYPE='magnetoresistive bridge';
%Typical cal: [750 -250; 750 -25-; 750 -250];
MAG.POLY=[682.2975 -212.5638; 667.0047 -224.7827; 697.0499 -252.2889];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
