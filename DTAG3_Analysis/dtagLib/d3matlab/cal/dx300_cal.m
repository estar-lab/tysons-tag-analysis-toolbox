%Cal file for dx300, Dtag3X Core version
DEV = struct ;
DEV.ID='27232f19';
DEV.NAME='DX300';
DEV.BUILT=[2016 4 28];
...
PRESS=struct;
PRESS.POLY=[369310 99251 -109];
PRESS.METHOD='rough';
PRESS.LASTCAL=[2016 4 29];
PRESS.TREF = 20 ;
...
ACC.POLY=[443 -6.26; 408 -5.7; 410 -5.7];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
ACC.METHOD='flips';
ACC.LASTCAL=[2016 4 28];

MAG=struct;
MAG.TYPE='magnetoresistive bridge';
MAG.POLY=[22706.1113835384,-203.369923509709; 20832.6698502431,-134.860738401647; 22543.9248736559,-167.636281198925];
MAG.UNIT='Tesla';
MAG.TREF = 20;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
