...
PRESS=struct;
PRESS.POLY=[-38.526722 2651.4015 -103.57555];
PRESS.METHOD='rough';
...
ACC.POLY=[10.1070 -5.0848; 10.1112 -5.0632; 9.9929 -4.9851];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[774.9720 -289.0849; 756.0702 -225.8262; 697.7240 -283.1553];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
