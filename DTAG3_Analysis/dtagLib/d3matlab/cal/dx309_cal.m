...
PRESS.POLY=[-37.49 2757.40 -117.78];
PRESS.METHOD='rough';
...
ACC.POLY=[10.08 -5.04; 10.05 -5.02; 10.15 -5.02];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[798.86 -263.11; 770.20 -271.41; 727.77 -280.74];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
