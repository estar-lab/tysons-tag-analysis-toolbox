...
PRESS.POLY=[-16.602322 2732.2087 -73.876278];
PRESS.METHOD='rough';
PRESS.LASTCAL=[2017 5 10];
PRESS.TREF = 20 ;
...
ACC.POLY=[10.1254 -5.0126;10.0619 -5.0078;10.0192 -4.9983];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
ACC.METHOD='flips';
ACC.LASTCAL=[2017 5 10];

MAG=struct;
MAG.TYPE='magnetoresistive bridge';
%Typical cal: [750 -250; 750 -25-; 750 -250];
MAG.POLY=[695.9707 -220.2439;700.3756 -215.5067 ;708.2198 -239.4239];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
