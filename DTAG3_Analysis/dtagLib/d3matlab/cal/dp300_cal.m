%Cal file for dp300, Dtag3X Prototype
...
PRESS=struct;
PRESS.POLY=[79.37122 2447.3033 -78.1009];
PRESS.METHOD='rough';
...
ACC.POLY=[5.0056 -2.4608; 4.9337 -2.4779; 4.912 -2.4233];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[818.3965 -253.7662; 754.9379 -239.5966; 756.9619 -255.8215];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
