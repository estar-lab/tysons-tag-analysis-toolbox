...
PRESS=struct;
PRESS.POLY=[82.54, 2393.37, -82.80];
PRESS.METHOD='rough';
...
ACC.POLY=[10.0756, -5.0606; 10.0801, -4.9901; 10.0219, -4.9918];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[714.6557, -219.7938; 710.4018, -178.0616; 699.9854, -200.9881];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
...
DEV.CAL = CAL ;
writematxml(DEV,'DEV','dx326c.xml')
