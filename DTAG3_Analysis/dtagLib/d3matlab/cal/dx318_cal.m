...
PRESS=struct;
PRESS.POLY=[-71.23 2894.05 -123.02];
PRESS.METHOD='rough';
...
ACC.POLY=[10.0417 -4.9910; 10.1008 -5.0476; 9.9704 -4.9683];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[699.8321 -238.8201; 677.3684 -176.2164; 679.0450 -259.4906];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
