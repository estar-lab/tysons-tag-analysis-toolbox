...
PRESS=struct;
PRESS.POLY=[-55.882 2953.0862 -107.132];
PRESS.METHOD='rough';
...
ACC.POLY=[10.1237 -5.04801; 10.094 -5.0373; 10.16 -5.04637];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[696.2274 -219.4089; 708.1969 -230.5438; 716.4079 -244.5665];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
