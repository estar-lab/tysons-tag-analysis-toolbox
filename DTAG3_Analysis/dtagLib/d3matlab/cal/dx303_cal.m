...
PRESS=struct;
PRESS.POLY=[13.090 2780.8856 -100.389];
PRESS.METHOD='rough';
PRESS.LASTCAL=[2016 5 31];
PRESS.TREF = 20 ;
...
ACC.POLY=[10.106 -5.082; 10.115 -5.02; 10.121 -5.02];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[704.162 -227.077; 711.733 -200.645; 711.733 -241.872];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
