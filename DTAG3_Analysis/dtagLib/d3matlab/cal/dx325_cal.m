...
PRESS=struct;
PRESS.POLY=[60.85, 2315.06, -111.45];
PRESS.METHOD='rough';
...
ACC.POLY=[10.0874, -5.0770; 10.0818, -5.0553; 9.8329, -4.8485];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[655.5708, -202.0520; 648.6519, -197.9823; 671.6914, -217.3289];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
