...
PRESS=struct;
PRESS.POLY=[36.98, 2632.30, -109.45];
PRESS.METHOD='rough';
...
ACC.POLY=[10.0955, -5.0258; 10.0648, -4.9894; 10.0273, -4.9923];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[706.6629, -214.7130; 703.5770, -268.0109; 729.0459, -236.7401];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
...
DEV.CAL = CAL ;
writematxml(DEV,'DEV','dx329c.xml')
