...
PRESS=struct;
PRESS.POLY=[-82.30 2430.90 -93.40];
PRESS.METHOD='rough';
...
ACC.POLY=[10.0849 -5.0236; 10.0511 -5.0424; 10.0163 -5.0003];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[719.1394 -264.5792; 709.1514 -216.5758; 692.3241 -207.7727];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
