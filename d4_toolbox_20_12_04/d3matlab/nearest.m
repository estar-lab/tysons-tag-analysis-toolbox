...
%	  changed name from nearest 13/07/22 due to conflict
%		with Matlab function of the same name.

kx = [] ; mind = [] ;
fprintf('Warning: nearest has been replaced with closest\n') ;
fprintf('nearest still works but will be removed soon.\n') ;
