...
%		IN DEVELOPMENT - MAY NOT YET BE GENERALLY USEFUL
...
%        are OPTS.fh, OPTS.blank, OPTS.thrave, OPTS.DT, OPTS.df, OPTS.minthr,
%        and OPTS.channel.
...
%  	Last modified 24 March 2022 - added option to specify audio channel
...
if ~isfield(OPTS,'ch'),
   OPTS.ch = 1 ;
elseif OPTS.ch>size(x,2),
	fprintf('Audio data only has %d channels; selecting channel 1\n',size(x,2)) ;
   OPTS.ch = 1 ;
end
