function    d3preprocgps(recdir,prefix,suffix,fnums,ns)
%
...
%		ns is an optional vector of [start_sample end_sample] to specify a
%		 sub-section of each grab to analyse. Default is to process the entire grab.
%
...
% %% REMOVE THIS. THIS IS A TEMPORARY FIX FOR PM24_186B
% dtype = 4;
% if isempty(dtype),
...
for k=fnums,
   ...
   if exist(fname,'file'),
      ...
      obs = proc_gpsbinfile(fname,[],dtype,ns) ;
