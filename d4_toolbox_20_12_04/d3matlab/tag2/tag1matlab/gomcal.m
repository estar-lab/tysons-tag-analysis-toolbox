...
switch tagrun
   ...
   case 'pw03_082a'
      % pw03_082a used tag #11, 48kHz sampling
  	   p_cal = [435.5 1.656 0] ;
   	t_cal = [3800 -63.3] ;
      a_cal = [1962.4-116.7 694.9;
              1876.4+41.7 725.6;
  ...
  case 'pw03_082b'
   ...
   case 'pw03_082d'
      % pw03_082d used tag #11, 48kHz sampling
  	   p_cal = [435.5 1.656 0] ;
   	t_cal = [3800 -63.3] ;
      a_cal = [1962.4-116.7 694.9;
              1876.4+41.7 725.6;
 ...
 case 'sw03_173b'
      % sw03_173b used tag #13, 32kHz sampling
   	p_cal = [421 1.7044 0] ;
   	t_cal = [3800 -63.3] ;
      a_cal = [1858.7-5.4+45.32 627.7;
              1960.7-6.7+12.2 619.4;
              1923.8+11.2-79.36 716.9] ;
      ax_cal = [-0.6e-4+0.36e-3 -1.3e-3 1 0 0;
              -1.9e-4+0.16e-3 -4e-4 0 1 0;
              -1.2e-4-0.18e-3 1e-4 0 0 1] ;
      m_cal = [2386.7-1.5-8.52 8.35;
               2084.8+0.8+19.2 9.58;
               1877-12+117.1 10.75] ;
      mx_cal = [0.05-0.02 1 0 -0.03;
               -0.15+0.08 0 1 0.01;
               0.24-0.33 0 0 1] ;
      k = 1:1.2e5 ;
