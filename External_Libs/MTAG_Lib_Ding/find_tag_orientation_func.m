...
% 04/25/2022: Updated RANSAC's parameter and it's iteration calculation
%             method ("computeLoopNumber_local.m").
% ====================
...
function [Af0, Aa0, Ad0, model_1, model_2, in_pct] = fit_fad(method)
  ...
  [model_1, idx_in_1] = ransac_local(data_1,fitFcn_1,distFcn,sampleSize_1,...
    maxDistance, 'MaxSamplingAttempts', 5000, 'MaxNumTrials', 5000,...
    'Confidence', 99.999);
