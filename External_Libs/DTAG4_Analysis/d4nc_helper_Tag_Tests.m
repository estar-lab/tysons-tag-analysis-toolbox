...
recdir = ['C:\Users\tyson\Documents\ESTAR\Analysis\', depid];
...
info.project_datetime_start = '13January24 08:30:00'; %local time
...
itv = [.1 2.3]; % Set interval in minutes, 10 minute max duration recommended
