function    [p,CAL,fs,t] = d3calpressure(X,CAL,test)
...
fprintf([' Select points in Fig 2 by enclosing in rectangles using the ', ...
    'left mouse button\n Selected points should correspond to surfacings\n']);
...
prompt = 'Accept new calibration, redo or quit? Type y, r, or q...';
s = input(prompt, 's') ;
s = char(s) ;
fprintf('\n') ;
