...
PRESS.POLY=[-76.38 2945.68 -104.54];
PRESS.METHOD='rough';
...
ACC.POLY=[10.08 -4.99; 10.11 -5.00; 10.03 -5.00];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
%Typical cal: [7xx -2xx; 7xx -2xx; 7xx -2xx];
MAG.POLY=[718.7469 -241.6369; 714.8722 -208.4515; 740.8313 -253.5618];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
