%Dtag3X #332HC Cal file template
...
PRESS=struct;
PRESS.POLY=[243.58, 1921.66, -71.73];
PRESS.METHOD='rough';
...
ACC.POLY=[15.0242, -7.3753; 15.3775, -7.6332; 15.1719, -7.5845];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[718.1310, -244.4536; 708.0165, -230.6699; 677.0259, -207.8699];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
...
DEV.CAL = CAL ;
writematxml(DEV,'DEV','dx332hc.xml')
