...
PRESS=struct;
PRESS.POLY=[158.99, 2357.34, -111.41];
PRESS.METHOD='rough';
...
ACC.POLY=[10.1090, -5.0248; 10.0578, -4.9997; 9.9959, -4.9858];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[658.7564, -212.4317; 622.9688, -214.0631; 642.3558, -204.8581];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
