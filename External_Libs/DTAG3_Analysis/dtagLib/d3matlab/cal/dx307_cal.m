...
PRESS.POLY=[-20.43 2223.14 -80.73];
PRESS.METHOD='rough';
...
ACC.POLY=[10.06 -5.06; 10.11 -5.06; 10.16 -5.07];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[680.56 -205.13; 705.51 -242.65; 705.51 -162.57];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
