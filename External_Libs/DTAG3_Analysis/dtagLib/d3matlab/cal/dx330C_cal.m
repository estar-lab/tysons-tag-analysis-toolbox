...
PRESS=struct;
PRESS.POLY=[101.65, 2373.38, -90.62];
PRESS.METHOD='rough';
...
ACC.POLY=[10.0517, -5.0568; 10.0673, -4.9910; 9.9768, -4.9941];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[682.9920, -172.2876; 685.8378, -226.2848; 706.4424 -213.7393];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
...
DEV.CAL = CAL ;
writematxml(DEV,'DEV','dx330c.xml')
