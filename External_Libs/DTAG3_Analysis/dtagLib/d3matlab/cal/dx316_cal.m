...
PRESS=struct;
PRESS.POLY=[55.92 2615.36 -100.66];
PRESS.METHOD='rough';
PRESS.LASTCAL=[2018 8 2];
PRESS.TREF = 20 ;
...
ACC.POLY=[10.04 -5.03; 10.07 -5.0 ; 10.14 -5.05];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
ACC.METHOD='flips';
ACC.LASTCAL=[2018 8 2];

MAG=struct;
MAG.TYPE='magnetoresistive bridge';
MAG.POLY=[716.71 -217.21; 724.93 -204.15; 744.12 -241.29];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
