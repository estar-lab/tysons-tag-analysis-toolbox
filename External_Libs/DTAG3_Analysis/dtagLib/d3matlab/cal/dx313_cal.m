%Dtag3X #313 Cal file template
%Initial Calibration - 6/28/2018
...
PRESS=struct;
PRESS.POLY=[-20.8055 2696.8330 -106.4033];
PRESS.METHOD='rough';
PRESS.LASTCAL=[2018 6 28];
PRESS.TREF = 20 ;
...
ACC.POLY=[10.0819 -5.0734; 10.0781 -5.0252; 10.2414 -5.1006];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
ACC.METHOD='flips';
ACC.LASTCAL=[2018 6 28];

MAG=struct;
MAG.TYPE='magnetoresistive bridge';
MAG.POLY=[722.4585 -230.6516; 707.3020 -218.3492; 729.4052 -257.577];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
