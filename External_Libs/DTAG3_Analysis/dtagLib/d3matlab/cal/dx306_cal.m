...
PRESS.POLY=[244.25 2387.25 -59.44];
PRESS.METHOD='rough';
...
ACC.POLY=[10.11 -5.10; 10.05 -5.02; 10.14 -5.07];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[693.06 -255.26; 703.60 -178.34; 698.29 -203.93];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
