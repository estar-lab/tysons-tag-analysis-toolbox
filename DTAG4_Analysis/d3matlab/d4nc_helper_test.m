...
recdir=['C:\Users\jtgabaldon\Desktop\Extras\d4install\data\', depid];
...
% or
X = d3readswv(recdir,depid,1) ;		% decimates each channel by a factor of 5
...
info = make_info(depid,'D4',depid(1:2),'jg');
info.project_name = 'DQO';
info.project_datetime_start = '2017/06/12';
info.project_datetime_end = '2017/06/15';
info.dephist_deploy_locality = 'Oahu, HI';
